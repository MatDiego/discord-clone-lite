 ...
 */
final class Version20260308184147 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE channel_read_state ADD CONSTRAINT FK_4ADAFEB9384BCFBF FOREIGN KEY (last_read_message_id) REFERENCES message (id) NOT DEFERRABLE');
    }
